...
func (c *questionServiceClient) ReadQuestion(ctx context.Context, in *ReadQuestionRequest, opts ...grpc.CallOption) (*ReadQuestionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/question.QuestionService/ReadQuestion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *questionServiceClient) ListQuestions(ctx context.Context, in *ListQuestionsRequest, opts ...grpc.CallOption) (*ListQuestionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/question.QuestionService/ListQuestions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QuestionService_ReadQuestion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/question.QuestionService/ReadQuestion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _QuestionService_ListQuestions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/question.QuestionService/ListQuestions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
